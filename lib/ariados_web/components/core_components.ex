defmodule AriadosWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AriadosWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AriadosWeb.Gettext, "errors", msg, opts)
    end
  end
